...
class DashboardViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    private func setupViewModel() {
           ...
           let products = [
               Product(imageName: "product_image", title: "Digital Entrepreneur", price: "₦4,000"),
               Product(imageName: "comeback_image", title: "Comeback Phoenix", price: "₦3,000"),
               Product(imageName: "product_image1", title: "Transition To Tech", price: "₦3,500"),
               Product(imageName: "product_image3", title: "How to start a Business", price: "₦4,000"),
               Product(imageName: "product_image4", title: "Graphics Design", price: "₦3,000"),
               Product(imageName: "product_image", title: "Digital Entrepreneur", price: "₦4,000"),
               Product(imageName: "product_image2", title: "Comeback Phoenix", price: "₦3,000"),
               Product(imageName: "product_image1", title: "Transition To Tech", price: "₦3,500"),
               Product(imageName: "product_image3", title: "How to start a Business", price: "₦4,000"),
               Product(imageName: "product_image4", title: "Graphics Design", price: "₦3,000"),
               Product(imageName: "product_image", title: "Digital Entrepreneur", price: "₦4,000"),
